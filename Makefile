.PHONY: build php php-cli php-apache rebuild clean Dockerfile Dockerfile-cli Dockerfile-apache show clean push phpv php5.4-cli php5.5-cli php5.6-cli php7-cli php5.4-apache php5.5-apache php5.6-apache php7-apache
...
Dockerfile-cli: Dockerfile5.4-cli Dockerfile5.5-cli Dockerfile5.6-cli Dockerfile7-cli
...
php7.1-cli-test: check Dockerfile7.1-cli-test
	docker build -t t4cc0re/php-env:7.1-cli-test $(OPTS) -f Dockerfile7-cli-test .
...
php7.1-apache-test: check Dockerfile7.1-apache-test
	docker build -t t4cc0re/php-env:7.1-apache-test $(OPTS) -f Dockerfile7-apache-test .
